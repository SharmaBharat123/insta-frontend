...
const Form = () => {
    ...
    const handlePost = (e) => {
        ...
        axios.post("https://insta-clone-clone.onrender.com/api/v1/posts/addpost", {
            ...
            <section className="form-container">
                ...
                <form className="form" action="/addpost" method="post" onSubmit={handlePost}>
                    ...
                    <article className="form-details-1">
                        <input type="text" name="author" placeholder="  Author" onChange={(e) => setForm({ ...form, author: e.target.value })} value={form.author} required/>
                        <input type="text" name="location" placeholder="  Location" onChange={(e) => setForm({ ...form, location: e.target.value })} value={form.location} required/>
                    </article>



                    <article className="form-details-2">
                        <input type="text" name="description" placeholder="  Description" onChange={(e) => setForm({ ...form, description: e.target.value })} value={form.description} required/>
                    </article>
                    {
                    //    isValid &&
